...
import { Grid, useDisclosure, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter, Image, Button, Text } from '@chakra-ui/core';

export default function UserDisplay({ user, logout }) {
  const { isOpen, onOpen, onClose } = useDisclosure();
  return (
    <Button p={2} variant="ghost" onClick={onOpen}>
      <Image rounded="full" size="2rem" marginRight={1} src={user.picture} alt="User Profile"/>
      { user.name }
